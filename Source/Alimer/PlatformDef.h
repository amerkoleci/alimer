...
#define ALIMER_COMPILER_MINGW 0
...
#define ALIMER_PLATFORM_BROWSER 0
...
#    undef ALIMER_COMPILER_MINGW
#    define ALIMER_COMPILER_MINGW 1
#    define ALIMER_COMPILER_NAME "MinGW"
#endif
...
#    undef ALIMER_PLATFORM_BROWSER
#    define ALIMER_PLATFORM_BROWSER 1
...
/** SIMD defines */
//#define ALIMER_SIMD_DISABLED
#if !defined(ALIMER_SIMD_DISABLED)
#if defined(__EMSCRIPTEN__)
#define ALIMER_USE_WASM
...
#if !defined(ALIMER_CPP20)
#   if __cplusplus >= 202002L || _MSVC_LANG >= 202002L // C++20
#       define ALIMER_CPP20 1
#   else
#   define ALIMER_CPP20 0
#   endif
#endif /* !defined(ALIMER_CPP20) */
...
/* CLang */
#if defined(__clang__)
#define ALIMER_PRAGMA(x)					_Pragma(#x)
#define ALIMER_SUPPRESS_WARNING_PUSH		ALIMER_PRAGMA(clang diagnostic push)
#define ALIMER_SUPPRESS_WARNING_POP		    ALIMER_PRAGMA(clang diagnostic pop)
#define ALIMER_CLANG_SUPPRESS_WARNING(w)	ALIMER_PRAGMA(clang diagnostic ignored w)

#if __clang_major__ >= 13
#   define ALIMER_CLANG_13_PLUS_SUPPRESS_WARNING(w) ALIMER_CLANG_SUPPRESS_WARNING(w)
#else
#   define ALIMER_CLANG_13_PLUS_SUPPRESS_WARNING(w)
#endif

#if __clang_major__ >= 16
#   define ALIMER_CLANG_16_PLUS_SUPPRESS_WARNING(w) ALIMER_CLANG_SUPPRESS_WARNING(w)
#else
#   define ALIMER_CLANG_16_PLUS_SUPPRESS_WARNING(w)
#endif
...
#else
#define ALIMER_CLANG_SUPPRESS_WARNING(w)
#define ALIMER_CLANG_13_PLUS_SUPPRESS_WARNING(w)
#define ALIMER_CLANG_16_PLUS_SUPPRESS_WARNING(w)
#endif
...
#define ALIMER_PRAGMA(x)					_Pragma(#x)
#define ALIMER_SUPPRESS_WARNING_PUSH		ALIMER_PRAGMA(GCC diagnostic push)
#define ALIMER_SUPPRESS_WARNING_POP		    ALIMER_PRAGMA(GCC diagnostic pop)
#define ALIMER_GCC_SUPPRESS_WARNING(w)		ALIMER_PRAGMA(GCC diagnostic ignored w)
...
#else
#define ALIMER_GCC_SUPPRESS_WARNING(w)
#endif

/* MSVC */
#if defined(_MSC_VER)
#define ALIMER_PRAGMA(x)					__pragma(x)
#define ALIMER_SUPPRESS_WARNING_PUSH		ALIMER_PRAGMA(warning (push))
#define ALIMER_SUPPRESS_WARNING_POP		    ALIMER_PRAGMA(warning (pop))
#define ALIMER_MSVC_SUPPRESS_WARNING(w)	    ALIMER_PRAGMA(warning (disable : w))
...
#else
#define ALIMER_MSVC_SUPPRESS_WARNING(w)
#endif
