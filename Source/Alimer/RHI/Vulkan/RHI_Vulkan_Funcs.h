...
VULKAN_DEVICE_FUNCTION(vkFreeDescriptorSets)
...
VULKAN_DEVICE_FUNCTION(vkCreateBufferView)
...
VULKAN_DEVICE_FUNCTION(vkGetDeviceQueue2)
...
VULKAN_DEVICE_FUNCTION(vkCreateRayTracingPipelinesKHR)
