...
namespace Alimer
{
    ...
    ALIMER_API uint32_t CompressData(void* dest, const void* src, uint32_t srcSize, uint32_t compressionLevel = 0);
    ...
    ALIMER_API uint32_t DecompressData(void* dest, const void* src, uint32_t destSize);
