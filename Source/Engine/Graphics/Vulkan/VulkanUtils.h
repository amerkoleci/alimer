...
#undef STR
    ...
    inline const VulkanBuffer* ToVulkan(const Buffer* resource)
    {
        return checked_cast<const VulkanBuffer*>(resource);
    }

    inline VulkanShader* ToVulkan(Shader* resource)
    {
        return checked_cast<VulkanShader*>(resource);
    }

    inline const VulkanPipeline* ToVulkan(const Pipeline* resource)
    {
        return checked_cast<const VulkanPipeline*>(resource);
    }
}
