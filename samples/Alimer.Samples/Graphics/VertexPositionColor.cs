...
public readonly record struct VertexPositionColor
{
    ...
    [
        new VertexAttribute(VertexAttributeSemantic.Position, VertexAttributeFormat.Float3, 0),
        new VertexAttribute(VertexAttributeSemantic.Color, VertexAttributeFormat.Float4, 12)
    ];
