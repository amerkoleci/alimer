...
namespace Alimer.Graphics
{
    ...
    public static unsafe class VGPU
    {
        ...
        private static NativeLibrary LoadLibrary()
        {
            ...
            {
                return new NativeLibrary("glfw3");
            }
        }
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate void vgpuBeginFrameDelegate(GPUDevice device);
        ...
        public static void vgpuBeginFrame(GPUDevice device) => vgpuBeginFrame_ptr(device);
