...
#define VK_CHECK(x) \
	...
	{ \
		...
		if (err < 0) \
		{ \
			agpuLogError("Detected Vulkan error: %s", VkResultToString(err)); \
		} \
	} while (0)
#else
...
#undef STR
        ...
        void* pUserData)
    {
        ...
        {
            agpuLogWarn("Vulkan - %s: %s", messageTypeStr, pCallbackData->pMessage);
        }
        else if (messageSeverity & VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT)
        {
            agpuLogError("Vulkan - %s: %s", messageTypeStr, pCallbackData->pMessage);
#if defined(_DEBUG)
            ALIMER_DEBUG_BREAK();
#endif
        }
    ...
    bool ValidateLayers(const std::vector<const char*>& required, const std::vector<VkLayerProperties>& available)
    {
        for (auto layer : required)
        {
            ...
            if (!found)
            {
                agpuLogWarn("Validation Layer '%s' not found", layer);
                return false;
            }
        }
    ...
    [[nodiscard]] constexpr VkFormat ToVkFormat(GPUPixelFormat format)
    {
        switch (format)
        {
            // 8-bit formats
            case GPUPixelFormat_R8Unorm:                    return VK_FORMAT_R8_UNORM;
            case GPUPixelFormat_R8Snorm:                    return VK_FORMAT_R8_SNORM;
            case GPUPixelFormat_R8Uint:                     return VK_FORMAT_R8_UINT;
            case GPUPixelFormat_R8Sint:                     return VK_FORMAT_R8_SINT;
                // 16-bit formats
            case GPUPixelFormat_R16Uint:                    return VK_FORMAT_R16_UINT;
            case GPUPixelFormat_R16Sint:                    return VK_FORMAT_R16_SINT;
            case GPUPixelFormat_R16Unorm:                   return VK_FORMAT_R16_UNORM;
            case GPUPixelFormat_R16Snorm:                   return VK_FORMAT_R16_SNORM;
            case GPUPixelFormat_R16Float:                   return VK_FORMAT_R16_SFLOAT;
            case GPUPixelFormat_RG8Unorm:                   return VK_FORMAT_R8G8_UNORM;
            case GPUPixelFormat_RG8Snorm:                   return VK_FORMAT_R8G8_SNORM;
            case GPUPixelFormat_RG8Uint:                    return VK_FORMAT_R8G8_UINT;
            case GPUPixelFormat_RG8Sint:                    return VK_FORMAT_R8G8_SINT;
                // Packed 16-Bit Pixel Formats
            case GPUPixelFormat_B5G6R5Unorm:                return VK_FORMAT_B5G6R5_UNORM_PACK16;
            case GPUPixelFormat_BGR5A1Unorm:                return VK_FORMAT_B5G5R5A1_UNORM_PACK16;
            case GPUPixelFormat_BGRA4Unorm:                 return VK_FORMAT_B4G4R4A4_UNORM_PACK16;
                // 32-bit formats
            case GPUPixelFormat_R32Uint:                    return VK_FORMAT_R32_UINT;
            case GPUPixelFormat_R32Sint:                    return VK_FORMAT_R32_SINT;
            case GPUPixelFormat_R32Float:                   return VK_FORMAT_R32_SFLOAT;
            case GPUPixelFormat_RG16Uint:                   return VK_FORMAT_R16G16_UINT;
            case GPUPixelFormat_RG16Sint:                   return VK_FORMAT_R16G16_SINT;
            case GPUPixelFormat_RG16Unorm:                  return VK_FORMAT_R16G16_UNORM;
            case GPUPixelFormat_RG16Snorm:                  return VK_FORMAT_R16G16_SNORM;
            case GPUPixelFormat_RG16Float:                  return VK_FORMAT_R16G16_SFLOAT;
            case GPUPixelFormat_RGBA8Unorm:                 return VK_FORMAT_R8G8B8A8_UNORM;
            case GPUPixelFormat_RGBA8UnormSrgb:             return VK_FORMAT_R8G8B8A8_SRGB;
            case GPUPixelFormat_RGBA8Snorm:                 return VK_FORMAT_R8G8B8A8_SNORM;
            case GPUPixelFormat_RGBA8Uint:                  return VK_FORMAT_R8G8B8A8_UINT;
            case GPUPixelFormat_RGBA8Sint:                  return VK_FORMAT_R8G8B8A8_SINT;
            case GPUPixelFormat_BGRA8Unorm:                 return VK_FORMAT_B8G8R8A8_UNORM;
            case GPUPixelFormat_BGRA8UnormSrgb:             return VK_FORMAT_B8G8R8A8_SRGB;
                // Packed 32-Bit formats
            case GPUPixelFormat_RGB10A2Unorm:               return VK_FORMAT_A2B10G10R10_UNORM_PACK32;
            case GPUPixelFormat_RGB10A2Uint:                return VK_FORMAT_A2R10G10B10_UINT_PACK32;
            case GPUPixelFormat_RG11B10Ufloat:               return VK_FORMAT_B10G11R11_UFLOAT_PACK32;
            case GPUPixelFormat_RGB9E5Ufloat:                return VK_FORMAT_E5B9G9R9_UFLOAT_PACK32;
                // 64-Bit formats
            case GPUPixelFormat_RG32Uint:                   return VK_FORMAT_R32G32_UINT;
            case GPUPixelFormat_RG32Sint:                   return VK_FORMAT_R32G32_SINT;
            case GPUPixelFormat_RG32Float:                  return VK_FORMAT_R32G32_SFLOAT;
            case GPUPixelFormat_RGBA16Uint:                 return VK_FORMAT_R16G16B16A16_UINT;
            case GPUPixelFormat_RGBA16Sint:                 return VK_FORMAT_R16G16B16A16_SINT;
            case GPUPixelFormat_RGBA16Unorm:                return VK_FORMAT_R16G16B16A16_UNORM;
            case GPUPixelFormat_RGBA16Snorm:                return VK_FORMAT_R16G16B16A16_SNORM;
            case GPUPixelFormat_RGBA16Float:                return VK_FORMAT_R16G16B16A16_SFLOAT;
                // 128-Bit formats
            case GPUPixelFormat_RGBA32Uint:                 return VK_FORMAT_R32G32B32A32_UINT;
            case GPUPixelFormat_RGBA32Sint:                 return VK_FORMAT_R32G32B32A32_SINT;
            case GPUPixelFormat_RGBA32Float:                return VK_FORMAT_R32G32B32A32_SFLOAT;
                // Depth-stencil formats
            //case GPUPixelFormat_Stencil8:                 return VK_FORMAT_S8_UINT;
            case GPUPixelFormat_Depth16Unorm:             return VK_FORMAT_D16_UNORM;
            case GPUPixelFormat_Depth24UnormStencil8:     return VK_FORMAT_D24_UNORM_S8_UINT;
            case GPUPixelFormat_Depth32Float:             return VK_FORMAT_D32_SFLOAT;
            case GPUPixelFormat_Depth32FloatStencil8:     return VK_FORMAT_D32_SFLOAT_S8_UINT;

                // Compressed BC formats
            case GPUPixelFormat_BC1RGBAUnorm:                 return VK_FORMAT_BC1_RGBA_UNORM_BLOCK;
            case GPUPixelFormat_BC1RGBAUnormSrgb:             return VK_FORMAT_BC1_RGBA_SRGB_BLOCK;
            case GPUPixelFormat_BC2RGBAUnorm:                 return VK_FORMAT_BC2_UNORM_BLOCK;
            case GPUPixelFormat_BC2RGBAUnormSrgb:             return VK_FORMAT_BC2_SRGB_BLOCK;
            case GPUPixelFormat_BC3RGBAUnorm:                 return VK_FORMAT_BC3_UNORM_BLOCK;
            case GPUPixelFormat_BC3RGBAUnormSrgb:             return VK_FORMAT_BC3_SRGB_BLOCK;
            case GPUPixelFormat_BC4RUnorm:                    return VK_FORMAT_BC4_UNORM_BLOCK;
            case GPUPixelFormat_BC4RSnorm:                    return VK_FORMAT_BC4_SNORM_BLOCK;
            case GPUPixelFormat_BC5RGUnorm:                   return VK_FORMAT_BC5_UNORM_BLOCK;
            case GPUPixelFormat_BC5RGSnorm:                   return VK_FORMAT_BC5_SNORM_BLOCK;
            case GPUPixelFormat_BC6HRGBUfloat:                return VK_FORMAT_BC6H_UFLOAT_BLOCK;
            case GPUPixelFormat_BC6HRGBFloat:                 return VK_FORMAT_BC6H_SFLOAT_BLOCK;
            case GPUPixelFormat_BC7RGBAUnorm:                 return VK_FORMAT_BC7_UNORM_BLOCK;
            case GPUPixelFormat_BC7RGBAUnormSrgb:             return VK_FORMAT_BC7_SRGB_BLOCK;
                // EAC/ETC compressed formats
            case GPUPixelFormat_ETC2RGB8Unorm:              return VK_FORMAT_ETC2_R8G8B8_UNORM_BLOCK;
            case GPUPixelFormat_ETC2RGB8UnormSrgb:          return VK_FORMAT_ETC2_R8G8B8_SRGB_BLOCK;
            case GPUPixelFormat_ETC2RGB8A1Unorm:            return VK_FORMAT_ETC2_R8G8B8A1_UNORM_BLOCK;
            case GPUPixelFormat_ETC2RGB8A1UnormSrgb:        return VK_FORMAT_ETC2_R8G8B8A1_SRGB_BLOCK;
            case GPUPixelFormat_ETC2RGBA8Unorm:             return VK_FORMAT_ETC2_R8G8B8A8_UNORM_BLOCK;
            case GPUPixelFormat_ETC2RGBA8UnormSrgb:         return VK_FORMAT_ETC2_R8G8B8A8_SRGB_BLOCK;
            case GPUPixelFormat_EACR11Unorm:                return VK_FORMAT_EAC_R11_UNORM_BLOCK;
            case GPUPixelFormat_EACR11Snorm:                return VK_FORMAT_EAC_R11_SNORM_BLOCK;
            case GPUPixelFormat_EACRG11Unorm:               return VK_FORMAT_EAC_R11G11_UNORM_BLOCK;
            case GPUPixelFormat_EACRG11Snorm:               return VK_FORMAT_EAC_R11G11_SNORM_BLOCK;
                // ASTC compressed formats
            case GPUPixelFormat_ASTC4x4Unorm:               return VK_FORMAT_ASTC_4x4_UNORM_BLOCK;
            case GPUPixelFormat_ASTC4x4UnormSrgb:           return VK_FORMAT_ASTC_4x4_SRGB_BLOCK;
            case GPUPixelFormat_ASTC5x4Unorm:               return VK_FORMAT_ASTC_5x4_UNORM_BLOCK;
            case GPUPixelFormat_ASTC5x4UnormSrgb:           return VK_FORMAT_ASTC_5x4_SRGB_BLOCK;
            case GPUPixelFormat_ASTC5x5Unorm:               return VK_FORMAT_ASTC_5x5_UNORM_BLOCK;
            case GPUPixelFormat_ASTC5x5UnormSrgb:           return VK_FORMAT_ASTC_5x5_SRGB_BLOCK;
            case GPUPixelFormat_ASTC6x5Unorm:               return VK_FORMAT_ASTC_6x5_UNORM_BLOCK;
            case GPUPixelFormat_ASTC6x5UnormSrgb:           return VK_FORMAT_ASTC_6x5_SRGB_BLOCK;
            case GPUPixelFormat_ASTC6x6Unorm:               return VK_FORMAT_ASTC_6x6_UNORM_BLOCK;
            case GPUPixelFormat_ASTC6x6UnormSrgb:           return VK_FORMAT_ASTC_6x6_SRGB_BLOCK;
            case GPUPixelFormat_ASTC8x5Unorm:               return VK_FORMAT_ASTC_8x5_UNORM_BLOCK;
            case GPUPixelFormat_ASTC8x5UnormSrgb:           return VK_FORMAT_ASTC_8x5_SRGB_BLOCK;
            case GPUPixelFormat_ASTC8x6Unorm:               return VK_FORMAT_ASTC_8x6_UNORM_BLOCK;
            case GPUPixelFormat_ASTC8x6UnormSrgb:           return VK_FORMAT_ASTC_8x6_SRGB_BLOCK;
            case GPUPixelFormat_ASTC8x8Unorm:               return VK_FORMAT_ASTC_8x8_UNORM_BLOCK;
            case GPUPixelFormat_ASTC8x8UnormSrgb:           return VK_FORMAT_ASTC_8x8_SRGB_BLOCK;
            case GPUPixelFormat_ASTC10x5Unorm:              return VK_FORMAT_ASTC_10x5_UNORM_BLOCK;
            case GPUPixelFormat_ASTC10x5UnormSrgb:          return VK_FORMAT_ASTC_10x5_SRGB_BLOCK;
            case GPUPixelFormat_ASTC10x6Unorm:              return VK_FORMAT_ASTC_10x6_UNORM_BLOCK;
            case GPUPixelFormat_ASTC10x6UnormSrgb:          return VK_FORMAT_ASTC_10x6_SRGB_BLOCK;
            case GPUPixelFormat_ASTC10x8Unorm:              return VK_FORMAT_ASTC_10x8_UNORM_BLOCK;
            case GPUPixelFormat_ASTC10x8UnormSrgb:          return VK_FORMAT_ASTC_10x8_SRGB_BLOCK;
            case GPUPixelFormat_ASTC10x10Unorm:             return VK_FORMAT_ASTC_10x10_UNORM_BLOCK;
            case GPUPixelFormat_ASTC10x10UnormSrgb:         return VK_FORMAT_ASTC_10x10_SRGB_BLOCK;
            case GPUPixelFormat_ASTC12x10Unorm:             return VK_FORMAT_ASTC_12x10_UNORM_BLOCK;
            case GPUPixelFormat_ASTC12x10UnormSrgb:         return VK_FORMAT_ASTC_12x10_SRGB_BLOCK;
            case GPUPixelFormat_ASTC12x12Unorm:             return VK_FORMAT_ASTC_12x12_UNORM_BLOCK;
            case GPUPixelFormat_ASTC12x12UnormSrgb:         return VK_FORMAT_ASTC_12x12_SRGB_BLOCK;
                // ASTC HDR compressed formats
            case GPUPixelFormat_ASTC4x4HDR:           return VK_FORMAT_ASTC_4x4_SFLOAT_BLOCK;
            case GPUPixelFormat_ASTC5x4HDR:           return VK_FORMAT_ASTC_5x4_SFLOAT_BLOCK;
            case GPUPixelFormat_ASTC5x5HDR:           return VK_FORMAT_ASTC_5x5_SFLOAT_BLOCK;
            case GPUPixelFormat_ASTC6x5HDR:           return VK_FORMAT_ASTC_6x5_SFLOAT_BLOCK;
            case GPUPixelFormat_ASTC6x6HDR:           return VK_FORMAT_ASTC_6x6_SFLOAT_BLOCK;
            case GPUPixelFormat_ASTC8x5HDR:           return VK_FORMAT_ASTC_8x5_SFLOAT_BLOCK;
            case GPUPixelFormat_ASTC8x6HDR:           return VK_FORMAT_ASTC_8x6_SFLOAT_BLOCK;
            case GPUPixelFormat_ASTC8x8HDR:           return VK_FORMAT_ASTC_8x8_SFLOAT_BLOCK;
            case GPUPixelFormat_ASTC10x5HDR:          return VK_FORMAT_ASTC_10x5_SFLOAT_BLOCK;
            case GPUPixelFormat_ASTC10x6HDR:          return VK_FORMAT_ASTC_10x6_SFLOAT_BLOCK;
            case GPUPixelFormat_ASTC10x8HDR:          return VK_FORMAT_ASTC_10x8_SFLOAT_BLOCK;
            case GPUPixelFormat_ASTC10x10HDR:         return VK_FORMAT_ASTC_10x10_SFLOAT_BLOCK;
            case GPUPixelFormat_ASTC12x10HDR:         return VK_FORMAT_ASTC_12x10_SFLOAT_BLOCK;
            case GPUPixelFormat_ASTC12x12HDR:         return VK_FORMAT_ASTC_12x12_SFLOAT_BLOCK;
    ...
    [[nodiscard]] constexpr GPUPixelFormat FromVkFormat(VkFormat vkFormat)
    {
        switch (vkFormat)
        {
            // 8-bit formats
            case VK_FORMAT_R8_UNORM:                        return GPUPixelFormat_R8Unorm;
            case VK_FORMAT_R8_SNORM:                        return GPUPixelFormat_R8Snorm;
            case VK_FORMAT_R8_UINT:                         return GPUPixelFormat_R8Uint;
            case VK_FORMAT_R8_SINT:                         return GPUPixelFormat_R8Sint;
                // 16-bit formats
            case VK_FORMAT_R16_UNORM:                       return GPUPixelFormat_R16Unorm;
            case VK_FORMAT_R16_SNORM:                       return GPUPixelFormat_R16Snorm;
            case VK_FORMAT_R16_UINT:                        return GPUPixelFormat_R16Uint;
            case VK_FORMAT_R16_SINT:                        return GPUPixelFormat_R16Sint;
            case VK_FORMAT_R16_SFLOAT:                      return GPUPixelFormat_R16Float;
            case VK_FORMAT_R8G8_UNORM:                      return GPUPixelFormat_RG8Unorm;
            case VK_FORMAT_R8G8_SNORM:                      return GPUPixelFormat_RG8Snorm;
            case VK_FORMAT_R8G8_UINT:                       return GPUPixelFormat_RG8Uint;
            case VK_FORMAT_R8G8_SINT:                       return GPUPixelFormat_RG8Sint;
                // Packed 16-Bit Pixel Formats
            case VK_FORMAT_B5G6R5_UNORM_PACK16:             return GPUPixelFormat_B5G6R5Unorm;
            case VK_FORMAT_B5G5R5A1_UNORM_PACK16:           return GPUPixelFormat_BGR5A1Unorm;
            case VK_FORMAT_B4G4R4A4_UNORM_PACK16:           return GPUPixelFormat_BGRA4Unorm;
                // 32-bit formats
            case VK_FORMAT_R32_UINT:                        return GPUPixelFormat_R32Uint;
            case VK_FORMAT_R32_SINT:                        return GPUPixelFormat_R32Sint;
            case VK_FORMAT_R32_SFLOAT:                      return GPUPixelFormat_R32Float;
            case VK_FORMAT_R16G16_UNORM:                    return GPUPixelFormat_RG16Unorm;
            case VK_FORMAT_R16G16_SNORM:                    return GPUPixelFormat_RG16Snorm;
            case VK_FORMAT_R16G16_UINT:                     return GPUPixelFormat_RG16Uint;
            case VK_FORMAT_R16G16_SINT:                     return GPUPixelFormat_RG16Sint;
            case VK_FORMAT_R16G16_SFLOAT:                   return GPUPixelFormat_RG16Float;
            case VK_FORMAT_R8G8B8A8_UNORM:                  return GPUPixelFormat_RGBA8Unorm;
            case VK_FORMAT_R8G8B8A8_SRGB:                   return GPUPixelFormat_RGBA8UnormSrgb;
            case VK_FORMAT_R8G8B8A8_SNORM:                  return GPUPixelFormat_RGBA8Snorm;
            case VK_FORMAT_R8G8B8A8_UINT:                   return GPUPixelFormat_RGBA8Uint;
            case VK_FORMAT_R8G8B8A8_SINT:                   return GPUPixelFormat_RGBA8Sint;
            case VK_FORMAT_B8G8R8A8_UNORM:                  return GPUPixelFormat_BGRA8Unorm;
            case VK_FORMAT_B8G8R8A8_SRGB:                   return GPUPixelFormat_BGRA8UnormSrgb;
                // Packed 32-Bit formats
            case VK_FORMAT_A2B10G10R10_UNORM_PACK32:        return GPUPixelFormat_RGB10A2Unorm;
            case VK_FORMAT_A2R10G10B10_UINT_PACK32:         return GPUPixelFormat_RGB10A2Uint;
            case VK_FORMAT_B10G11R11_UFLOAT_PACK32:         return GPUPixelFormat_RG11B10Ufloat;
            case VK_FORMAT_E5B9G9R9_UFLOAT_PACK32:          return GPUPixelFormat_RGB9E5Ufloat;
                // 64-Bit formats
            case VK_FORMAT_R32G32_UINT:                     return GPUPixelFormat_RG32Uint;
            case VK_FORMAT_R32G32_SINT:                     return GPUPixelFormat_RG32Sint;
            case VK_FORMAT_R32G32_SFLOAT:                   return GPUPixelFormat_RG32Float;
            case VK_FORMAT_R16G16B16A16_UNORM:              return GPUPixelFormat_RGBA16Unorm;
            case VK_FORMAT_R16G16B16A16_SNORM:              return GPUPixelFormat_RGBA16Snorm;
            case VK_FORMAT_R16G16B16A16_UINT:               return GPUPixelFormat_RGBA16Uint;
            case VK_FORMAT_R16G16B16A16_SINT:               return GPUPixelFormat_RGBA16Sint;
            case VK_FORMAT_R16G16B16A16_SFLOAT:             return GPUPixelFormat_RGBA16Float;
                // 128-Bit formats
            case VK_FORMAT_R32G32B32A32_UINT:               return GPUPixelFormat_RGBA32Uint;
            case VK_FORMAT_R32G32B32A32_SINT:               return GPUPixelFormat_RGBA32Sint;
            case VK_FORMAT_R32G32B32A32_SFLOAT:             return GPUPixelFormat_RGBA32Float;
                // Depth-stencil formats
            case VK_FORMAT_D16_UNORM:			            return GPUPixelFormat_Depth16Unorm;
            case VK_FORMAT_D32_SFLOAT:			            return GPUPixelFormat_Depth32Float;
            case VK_FORMAT_D24_UNORM_S8_UINT:               return GPUPixelFormat_Depth24UnormStencil8;
            case VK_FORMAT_D32_SFLOAT_S8_UINT:              return GPUPixelFormat_Depth32FloatStencil8;
                // Compressed BC formats
            case VK_FORMAT_BC1_RGBA_UNORM_BLOCK:            return GPUPixelFormat_BC1RGBAUnorm;
            case VK_FORMAT_BC1_RGBA_SRGB_BLOCK:             return GPUPixelFormat_BC1RGBAUnormSrgb;
            case VK_FORMAT_BC2_UNORM_BLOCK:                 return GPUPixelFormat_BC2RGBAUnorm;
            case VK_FORMAT_BC2_SRGB_BLOCK:                  return GPUPixelFormat_BC2RGBAUnormSrgb;
            case VK_FORMAT_BC3_UNORM_BLOCK:                 return GPUPixelFormat_BC3RGBAUnorm;
            case VK_FORMAT_BC3_SRGB_BLOCK:                  return GPUPixelFormat_BC3RGBAUnormSrgb;
            case VK_FORMAT_BC4_UNORM_BLOCK:                 return GPUPixelFormat_BC4RSnorm;
            case VK_FORMAT_BC4_SNORM_BLOCK:                 return GPUPixelFormat_BC4RUnorm;
            case VK_FORMAT_BC5_UNORM_BLOCK:                 return GPUPixelFormat_BC5RGUnorm;
            case VK_FORMAT_BC5_SNORM_BLOCK:                 return GPUPixelFormat_BC5RGSnorm;
            case VK_FORMAT_BC6H_UFLOAT_BLOCK:               return GPUPixelFormat_BC6HRGBUfloat;
            case VK_FORMAT_BC6H_SFLOAT_BLOCK:               return GPUPixelFormat_BC6HRGBFloat;
            case VK_FORMAT_BC7_UNORM_BLOCK:                 return GPUPixelFormat_BC7RGBAUnorm;
            case VK_FORMAT_BC7_SRGB_BLOCK:                  return GPUPixelFormat_BC7RGBAUnormSrgb;
                // EAC/ETC compressed formats
            case VK_FORMAT_ETC2_R8G8B8_UNORM_BLOCK:         return GPUPixelFormat_ETC2RGB8Unorm;
            case VK_FORMAT_ETC2_R8G8B8_SRGB_BLOCK:          return GPUPixelFormat_ETC2RGB8UnormSrgb;
            case VK_FORMAT_ETC2_R8G8B8A1_UNORM_BLOCK:       return GPUPixelFormat_ETC2RGB8A1Unorm;
            case VK_FORMAT_ETC2_R8G8B8A1_SRGB_BLOCK:        return GPUPixelFormat_ETC2RGB8A1UnormSrgb;
            case VK_FORMAT_ETC2_R8G8B8A8_UNORM_BLOCK:       return GPUPixelFormat_ETC2RGBA8Unorm;
            case VK_FORMAT_ETC2_R8G8B8A8_SRGB_BLOCK:        return GPUPixelFormat_ETC2RGBA8UnormSrgb;
            case VK_FORMAT_EAC_R11_UNORM_BLOCK:             return GPUPixelFormat_EACR11Unorm;
            case VK_FORMAT_EAC_R11_SNORM_BLOCK:             return GPUPixelFormat_EACR11Snorm;
            case VK_FORMAT_EAC_R11G11_UNORM_BLOCK:          return GPUPixelFormat_EACRG11Unorm;
            case VK_FORMAT_EAC_R11G11_SNORM_BLOCK:          return GPUPixelFormat_EACRG11Snorm;
                // ASTC compressed formats
            case VK_FORMAT_ASTC_4x4_UNORM_BLOCK:            return GPUPixelFormat_ASTC4x4Unorm;
            case VK_FORMAT_ASTC_4x4_SRGB_BLOCK:             return GPUPixelFormat_ASTC4x4UnormSrgb;
            case VK_FORMAT_ASTC_5x4_UNORM_BLOCK:            return GPUPixelFormat_ASTC5x4Unorm;
            case VK_FORMAT_ASTC_5x4_SRGB_BLOCK:             return GPUPixelFormat_ASTC5x4UnormSrgb;
            case VK_FORMAT_ASTC_5x5_UNORM_BLOCK:            return GPUPixelFormat_ASTC5x5Unorm;
            case VK_FORMAT_ASTC_5x5_SRGB_BLOCK:             return GPUPixelFormat_ASTC5x5UnormSrgb;
            case VK_FORMAT_ASTC_6x5_UNORM_BLOCK:            return GPUPixelFormat_ASTC6x5Unorm;
            case VK_FORMAT_ASTC_6x5_SRGB_BLOCK:             return GPUPixelFormat_ASTC6x5UnormSrgb;
            case VK_FORMAT_ASTC_6x6_UNORM_BLOCK:            return GPUPixelFormat_ASTC6x6Unorm;
            case VK_FORMAT_ASTC_6x6_SRGB_BLOCK:             return GPUPixelFormat_ASTC6x6UnormSrgb;
            case VK_FORMAT_ASTC_8x5_UNORM_BLOCK:            return GPUPixelFormat_ASTC8x5Unorm;
            case VK_FORMAT_ASTC_8x5_SRGB_BLOCK:             return GPUPixelFormat_ASTC8x5UnormSrgb;
            case VK_FORMAT_ASTC_8x6_UNORM_BLOCK:            return GPUPixelFormat_ASTC8x6Unorm;
            case VK_FORMAT_ASTC_8x6_SRGB_BLOCK:             return GPUPixelFormat_ASTC8x6UnormSrgb;
            case VK_FORMAT_ASTC_8x8_UNORM_BLOCK:            return GPUPixelFormat_ASTC8x8Unorm;
            case VK_FORMAT_ASTC_8x8_SRGB_BLOCK:             return GPUPixelFormat_ASTC8x8UnormSrgb;
            case VK_FORMAT_ASTC_10x5_UNORM_BLOCK:           return GPUPixelFormat_ASTC10x5Unorm;
            case VK_FORMAT_ASTC_10x5_SRGB_BLOCK:            return GPUPixelFormat_ASTC10x5UnormSrgb;
            case VK_FORMAT_ASTC_10x6_UNORM_BLOCK:           return GPUPixelFormat_ASTC10x6Unorm;
            case VK_FORMAT_ASTC_10x6_SRGB_BLOCK:            return GPUPixelFormat_ASTC10x6UnormSrgb;
            case VK_FORMAT_ASTC_10x8_UNORM_BLOCK:           return GPUPixelFormat_ASTC10x8Unorm;
            case VK_FORMAT_ASTC_10x8_SRGB_BLOCK:            return GPUPixelFormat_ASTC10x8UnormSrgb;
            case VK_FORMAT_ASTC_10x10_UNORM_BLOCK:          return GPUPixelFormat_ASTC10x10Unorm;
            case VK_FORMAT_ASTC_10x10_SRGB_BLOCK:           return GPUPixelFormat_ASTC10x10UnormSrgb;
            case VK_FORMAT_ASTC_12x10_UNORM_BLOCK:          return GPUPixelFormat_ASTC12x10Unorm;
            case VK_FORMAT_ASTC_12x10_SRGB_BLOCK:           return GPUPixelFormat_ASTC12x10UnormSrgb;
            case VK_FORMAT_ASTC_12x12_UNORM_BLOCK:          return GPUPixelFormat_ASTC12x12Unorm;
            case VK_FORMAT_ASTC_12x12_SRGB_BLOCK:           return GPUPixelFormat_ASTC12x12UnormSrgb;
                // ASTC HDR compressed formats
            case VK_FORMAT_ASTC_4x4_SFLOAT_BLOCK:           return GPUPixelFormat_ASTC4x4HDR;
            case VK_FORMAT_ASTC_5x4_SFLOAT_BLOCK:           return GPUPixelFormat_ASTC5x4HDR;
            case VK_FORMAT_ASTC_5x5_SFLOAT_BLOCK:           return GPUPixelFormat_ASTC5x5HDR;
            case VK_FORMAT_ASTC_6x5_SFLOAT_BLOCK:           return GPUPixelFormat_ASTC6x5HDR;
            case VK_FORMAT_ASTC_6x6_SFLOAT_BLOCK:           return GPUPixelFormat_ASTC6x6HDR;
            case VK_FORMAT_ASTC_8x5_SFLOAT_BLOCK:           return GPUPixelFormat_ASTC8x5HDR;
            case VK_FORMAT_ASTC_8x6_SFLOAT_BLOCK:           return GPUPixelFormat_ASTC8x6HDR;
            case VK_FORMAT_ASTC_8x8_SFLOAT_BLOCK:           return GPUPixelFormat_ASTC8x8HDR;
            case VK_FORMAT_ASTC_10x5_SFLOAT_BLOCK:          return GPUPixelFormat_ASTC10x5HDR;
            case VK_FORMAT_ASTC_10x6_SFLOAT_BLOCK:          return GPUPixelFormat_ASTC10x6HDR;
            case VK_FORMAT_ASTC_10x8_SFLOAT_BLOCK:          return GPUPixelFormat_ASTC10x8HDR;
            case VK_FORMAT_ASTC_10x10_SFLOAT_BLOCK:         return GPUPixelFormat_ASTC10x10HDR;
            case VK_FORMAT_ASTC_12x10_SFLOAT_BLOCK:         return GPUPixelFormat_ASTC12x10HDR;
            case VK_FORMAT_ASTC_12x12_SFLOAT_BLOCK:         return GPUPixelFormat_ASTC12x12HDR;

                //case VK_FORMAT_G8_B8R8_2PLANE_420_UNORM:      return PixelFormat::R8BG8Biplanar420Unorm;

            default:
                return GPUPixelFormat_Undefined;
        }
    }


    [[nodiscard]] constexpr GPUPixelFormat ToGPUSwapChainFormat(VkFormat format)
    {
        switch (format)
        {
            case VK_FORMAT_R8G8B8A8_UNORM:
                return GPUPixelFormat_RGBA8Unorm;
            case VK_FORMAT_R8G8B8A8_SRGB:
                return GPUPixelFormat_RGBA8UnormSrgb;
            case VK_FORMAT_B8G8R8A8_UNORM:
                return GPUPixelFormat_BGRA8Unorm;
            case VK_FORMAT_B8G8R8A8_SRGB:
                return GPUPixelFormat_BGRA8UnormSrgb;
            case VK_FORMAT_A2B10G10R10_UNORM_PACK32:
                return GPUPixelFormat_RGB10A2Unorm;
            case VK_FORMAT_R16G16B16A16_SFLOAT:
                return GPUPixelFormat_RGBA16Float;
            default:
                return GPUPixelFormat_Undefined;
        }
    };
    ...
    constexpr VkPolygonMode ToVk(GPUFillMode value, bool fillModeNonSolid)
    {
        switch (value)
        {
            ...
            case GPUFillMode_Wireframe:
                if (!fillModeNonSolid)
                {
                    agpuLogWarn("Vulkan: Wireframe fill mode is being used but it's not supported on this device");
                    return VK_POLYGON_MODE_FILL;
                }
...
#define VULKAN_DEVICE_FUNCTION(func) PFN_##func func = nullptr;
#include "alimer_gpu_vulkan_funcs.h"

    ~VulkanDevice() override;
    bool Initialize(const GPUDeviceDesc& desc);
...
VkImageView VulkanTexture::GetView(uint32_t mipLevel) const
{
    ...
    if (it == views.end())
    {
        ...
        {
            agpuLogError("Vulkan: Failed to create ImageView, error: %s", VkResultToString(result));
...
void VulkanRenderPassEncoder::SetBlendColor(const GPUColor* color)
{
...
void VulkanCommandBuffer::PushDebugGroup(const char* groupLabel) const
{
    ...
    label.color[2] = 0.0f;
    label.color[3] = 1.0f;
    queue->device->adapter->factory->vkCmdBeginDebugUtilsLabelEXT(handle, &label);
}
...
void VulkanCommandBuffer::PopDebugGroup() const
{
    ...
    queue->device->adapter->factory->vkCmdEndDebugUtilsLabelEXT(handle);
}
...
GPUComputePassEncoder VulkanCommandBuffer::BeginComputePass(const GPUComputePassDesc& desc)
{
    if (encoderActive)
    {
        agpuLogError("CommandEncoder already active");
        return nullptr;
    }
...
VulkanDevice::~VulkanDevice()
{
    ...
    if (allocator != nullptr)
    {
        ...
        {
            agpuLogWarn("Total device memory leaked: %" PRId64 " bytes.", stats.total.statistics.allocationBytes);
        }
#endif
    ...
    if (externalAllocator != nullptr)
    {
        ...
        if (stats.total.statistics.allocationBytes > 0)
        {
            agpuLogWarn("Total device external memory leaked: %" PRId64 " bytes.", stats.total.statistics.allocationBytes);
        }
#endif
...
#include "alimer_gpu_vulkan_funcs.h"
    ...
    if (adapter->features14.pushDescriptor == VK_FALSE
        && adapter->extensions.pushDescriptor == true)
    {
        vkCmdPushDescriptorSet = (PFN_vkCmdPushDescriptorSet)adapter->factory->vkGetDeviceProcAddr(handle, "vkCmdPushDescriptorSetKHR");
    }

    // Init limits
    limits.maxTextureDimension1D = adapter->properties2.properties.limits.maxImageDimension1D;
    limits.maxTextureDimension2D = adapter->properties2.properties.limits.maxImageDimension2D;
    limits.maxTextureDimension3D = adapter->properties2.properties.limits.maxImageDimension3D;
    limits.maxTextureDimensionCube = adapter->properties2.properties.limits.maxImageDimensionCube;
    limits.maxTextureArrayLayers = adapter->properties2.properties.limits.maxImageArrayLayers;
    limits.maxBindGroups = adapter->properties2.properties.limits.maxBoundDescriptorSets;
    limits.maxConstantBufferBindingSize = adapter->properties2.properties.limits.maxUniformBufferRange;
    ...
    limits.maxViewports = adapter->properties2.properties.limits.maxViewports;
    limits.viewportBoundsMin = adapter->properties2.properties.limits.viewportBoundsRange[0];
    limits.viewportBoundsMax = adapter->properties2.properties.limits.viewportBoundsRange[1];

    /* Compute */
    limits.maxComputeWorkgroupStorageSize = adapter->properties2.properties.limits.maxComputeSharedMemorySize;
    limits.maxComputeInvocationsPerWorkgroup = adapter->properties2.properties.limits.maxComputeWorkGroupInvocations;

    limits.maxComputeWorkgroupSizeX = adapter->properties2.properties.limits.maxComputeWorkGroupSize[0];
    limits.maxComputeWorkgroupSizeY = adapter->properties2.properties.limits.maxComputeWorkGroupSize[1];
    limits.maxComputeWorkgroupSizeZ = adapter->properties2.properties.limits.maxComputeWorkGroupSize[2];

    limits.maxComputeWorkgroupsPerDimension = std::min({
        adapter->properties2.properties.limits.maxComputeWorkGroupCount[0],
        adapter->properties2.properties.limits.maxComputeWorkGroupCount[1],
        adapter->properties2.properties.limits.maxComputeWorkGroupCount[2],
        }
        );
    ...
    if (adapter->extensions.fragmentShadingRate)
    {
        ...
        limits.isAdditionalVariableShadingRatesSupported = adapter->fragmentShadingRateProperties.maxFragmentSize.height > 2 || adapter->fragmentShadingRateProperties.maxFragmentSize.width > 2;
    }
        ...
        && adapter->rayTracingPipelineFeatures.rayTracingPipeline == VK_TRUE)
    {
        ...
        limits.rayTracingShaderGroupIdentifierSize = adapter->rayTracingPipelineProperties.shaderGroupHandleSize;
        limits.rayTracingShaderTableAlignment = adapter->rayTracingPipelineProperties.shaderGroupBaseAlignment;
        limits.rayTracingShaderTableMaxStride = adapter->rayTracingPipelineProperties.maxShaderGroupStride;
        limits.rayTracingShaderRecursionMaxDepth = adapter->rayTracingPipelineProperties.maxRayRecursionDepth;
        limits.rayTracingMaxGeometryCount = (uint32_t)adapter->accelerationStructureProperties.maxGeometryCount;
        limits.rayTracingScratchAlignment = adapter->accelerationStructureProperties.minAccelerationStructureScratchOffsetAlignment;
    }
    ...
    for (uint32_t i = 0; i < _GPUCommandQueueType_Count; i++)
    {
        if (adapter->queueFamilyIndices.familyIndices[i] != VK_QUEUE_FAMILY_IGNORED)
        {
            ...
            queues[i].frameFences.resize(maxFramesInFlight);
...
#ifdef _DEBUG
    agpuLogInfo("Enabled %d Device Extensions:", createInfo.enabledExtensionCount);
    for (uint32_t i = 0; i < createInfo.enabledExtensionCount; ++i)
    {
        agpuLogInfo("	\t%s", createInfo.ppEnabledExtensionNames[i]);
    }
#endif
    ...
    allocatorInfo.physicalDevice = adapter->handle;
    allocatorInfo.device = handle;
    allocatorInfo.instance = adapter->factory->handle;
    ...
    // Core in 1.3
    if (adapter->properties2.properties.apiVersion >= VK_API_VERSION_1_3
        || adapter->extensions.maintenance4)
    {
    ...
    vulkanFunctions.vkGetDeviceProcAddr = adapter->factory->vkGetDeviceProcAddr;
    ...
    result = vkCreatePipelineCache(handle, &pipelineCacheInfo, nullptr, &pipelineCache);
    if (result != VK_SUCCESS)
    {
        VK_LOG_ERROR(result, "Failed to create Vulkan external memory allocator");
        return false;
...
void VulkanDevice::ProcessDeletionQueue(bool force)
{
    ...
    Destroy(destroyedSurfaces, [&](auto& item) { adapter->factory->vkDestroySurfaceKHR(adapter->factory->handle, item, nullptr); });
    destroyMutex.unlock();
}
...
GPUTexture VulkanDevice::CreateTexture(const GPUTextureDesc& desc, const GPUTextureData* pInitialData)
{
    ...
    switch (desc.dimension)
    {
        ...
        default:
            agpuLogError("Invalid texture dimension");
            delete texture;
            return nullptr;
    }
    ...
    if (pInitialData != nullptr)
    {
        ...
        GPUPixelFormatInfo formatInfo = agpuPixelFormatGetInfo(desc.format);
...
GPUShaderModule VulkanDevice::CreateShaderModule(const GPUShaderModuleDesc* desc)
{
    ...
    const VkResult result = vkCreateShaderModule(handle, &moduleInfo, nullptr, &shaderModuleHandle);
    if (result != VK_SUCCESS)
    {
    ...
    shaderModule->entryPoint = desc->entryPoint;
    shaderModule->stageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
    shaderModule->stageInfo.pNext = nullptr;
    shaderModule->stageInfo.flags = 0;
    shaderModule->stageInfo.stage = (VkShaderStageFlagBits)ToVkShaderStageFlags(desc->stage);
    shaderModule->stageInfo.module = shaderModuleHandle;
    shaderModule->stageInfo.pName = shaderModule->entryPoint.c_str();
    shaderModule->stageInfo.pSpecializationInfo = nullptr;
...
GPURenderPipeline VulkanDevice::CreateRenderPipeline(const GPURenderPipelineDesc& desc)
{
    ...
    {
        vertexBindings.resize(desc.vertexBufferLayoutCount);
    ...
    for (uint32_t i = 0; i < desc.colorAttachmentCount; ++i)
    {
        if (desc.colorAttachments[i].format == GPUPixelFormat_Undefined)
            break;
...
GPUQueryHeap VulkanDevice::CreateQueryHeap(const GPUQueryHeapDesc& desc)
{
    ...
    {
        agpuLogError("Unsupported query type");
        return nullptr;
    }
...
void VulkanDevice::SetObjectName(VkObjectType type, uint64_t handle_, const char* label) const
{
    ...
    adapter->factory->vkSetDebugUtilsObjectNameEXT(handle, &nameInfo);
}
...
void VulkanSurface::GetCapabilities(GPUAdapter adapter, GPUSurfaceCapabilities* capabilities) const
{
    ...
    VkResult result = factory->vkGetPhysicalDeviceSurfaceCapabilitiesKHR(backendAdapter->handle, handle, &surfaceCaps);
    if (result != VK_SUCCESS)
        return;

    uint32_t formatCount;
    VK_CHECK(factory->vkGetPhysicalDeviceSurfaceFormatsKHR(backendAdapter->handle, handle, &formatCount, nullptr));
    std::vector<VkSurfaceFormatKHR> vkFormats(formatCount);
    VK_CHECK(factory->vkGetPhysicalDeviceSurfaceFormatsKHR(backendAdapter->handle, handle, &formatCount, vkFormats.data()));

    uint32_t presentModeCount;
    VK_CHECK(factory->vkGetPhysicalDeviceSurfacePresentModesKHR(backendAdapter->handle, handle, &presentModeCount, nullptr));
    std::vector<VkPresentModeKHR> vkPresentModes(presentModeCount);
    VK_CHECK(factory->vkGetPhysicalDeviceSurfacePresentModesKHR(backendAdapter->handle, handle, &presentModeCount, vkPresentModes.data()));
    ...
    {
        GPUPixelFormat format = ToGPUSwapChainFormat(surfaceFormat.format);
...
{
    handle = handle_;
    extensions = factory->QueryPhysicalDeviceExtensions(handle_);
    queueFamilyIndices = factory->QueryQueueFamilies(handle_, extensions.video.queue);
    ...
    {
        agpuLogError("Vulkan textureCompressionBC feature required or both textureCompressionETC2 and textureCompressionASTC required.");
        return false;
    }
...
VkFormat VulkanAdapter::ToVkFormat(GPUPixelFormat format) const
{
    ...
    if (format == GPUPixelFormat_Depth24UnormStencil8 && !supportsDepth24Stencil8)
    {
...
#include "alimer_gpu_vulkan_funcs.h"
    ...
    {
        agpuLogWarn("The Vulkan API version supported on the system (%d.%d.%d) is too low, at least %d.%d.%d is required.",
    ...
    {
        agpuLogWarn("The Vulkan API supported on the system uses an unexpected variant: %d.", VK_API_VERSION_VARIANT(apiVersion));
        return false;
    }
...
GPUFactory Vulkan_CreateFactory(const GPUFactoryDesc* desc)
{
    ...
    VkResult result = vkCreateInstance(&createInfo, nullptr, &factory->handle);
    if (result != VK_SUCCESS)
    {
...
#include "alimer_gpu_vulkan_funcs.h"
    ...
    if (validationMode != GPUValidationMode_Disabled && factory->debugUtils)
    {
        result = factory->vkCreateDebugUtilsMessengerEXT(factory->handle, &debugUtilsCreateInfo, nullptr, &factory->debugUtilsMessenger);
        if (result != VK_SUCCESS)
        {
...
#if defined(_DEBUG)
    agpuLogInfo("Created VkInstance with version: %d.%d.%d",
    ...
    {
        agpuLogInfo("Enabled %d Validation Layers:", createInfo.enabledLayerCount);

        for (uint32_t i = 0; i < createInfo.enabledLayerCount; ++i)
        {
            agpuLogInfo("	\t%s", createInfo.ppEnabledLayerNames[i]);
        }
    }

    agpuLogInfo("Enabled %d Instance Extensions:", createInfo.enabledExtensionCount);
    for (uint32_t i = 0; i < createInfo.enabledExtensionCount; ++i)
    {
        agpuLogInfo("	\t%s", createInfo.ppEnabledExtensionNames[i]);
    }
    ...
    VK_CHECK(factory->vkEnumeratePhysicalDevices(factory->handle, &physicalDeviceCount, nullptr));
    if (physicalDeviceCount == 0)
    {
        agpuLogError("Vulkan: Failed to find GPUs with Vulkan support");
        return nullptr;
    }

    factory->adapters.reserve(physicalDeviceCount);
    std::vector<VkPhysicalDevice> physicalDevices(physicalDeviceCount);
    VK_CHECK(factory->vkEnumeratePhysicalDevices(factory->handle, &physicalDeviceCount, physicalDevices.data()));
    ...
    for (VkPhysicalDevice physicalDevice : physicalDevices)
    {
        ...
        factory->vkGetPhysicalDeviceProperties2(physicalDevice, &physicalDeviceProperties);
        ...
        factory->vkGetPhysicalDeviceFeatures2(physicalDevice, &physicalDeviceFeatures);
        ...
        VulkanPhysicalDeviceExtensions extensions = factory->QueryPhysicalDeviceExtensions(physicalDevice);
        if (!extensions.swapchain)
        {
            continue;
        }

        VulkanQueueFamilyIndices queueFamilyIndices = factory->QueryQueueFamilies(physicalDevice, extensions.video.queue);
        ...
        adapter->debugUtils = factory->debugUtils;
        ...
        factory->adapters.push_back(adapter);
    }
