...
{ \
  if (FAILED(hr)) { \
    agpuLogError("[%s()] HRESULT error detected (0x%lX)", __FUNCTION__, hr); \
    __debugbreak(); \
    ExitProcess(1); \
  } \
} while(0)

#define D3D12_LOG_ERROR(hr, message) agpuLogError("%s, result: 0x%08X", message, hr);
...
namespace
{
        ...
        [[maybe_unused]] void* pContext)
    {
        ...
        {
            agpuLogError("D3D12 %s: %s [%s #%d]", severityStr, pDescription, categoryStr, ID);
        }
        else if (Severity == D3D12_MESSAGE_SEVERITY_WARNING)
        {
            agpuLogWarn("D3D12 %s: %s [%s #%d]", severityStr, pDescription, categoryStr, ID);
        }
        else
        {
            agpuLogInfo("D3D12 %s: %s [%s #%d]", severityStr, pDescription, categoryStr, ID);
        }
    }
    ...
    inline DXGI_FORMAT ToDxgiFormat(GPUPixelFormat format)
    {
        switch (format)
        {
            // 8-bit formats
            case GPUPixelFormat_R8Unorm:                  return DXGI_FORMAT_R8_UNORM;
            case GPUPixelFormat_R8Snorm:                  return DXGI_FORMAT_R8_SNORM;
            case GPUPixelFormat_R8Uint:                   return DXGI_FORMAT_R8_UINT;
            case GPUPixelFormat_R8Sint:                   return DXGI_FORMAT_R8_SINT;
                // 16-bit formats
            case GPUPixelFormat_R16Unorm:                 return DXGI_FORMAT_R16_UNORM;
            case GPUPixelFormat_R16Snorm:                 return DXGI_FORMAT_R16_SNORM;
            case GPUPixelFormat_R16Uint:                  return DXGI_FORMAT_R16_UINT;
            case GPUPixelFormat_R16Sint:                  return DXGI_FORMAT_R16_SINT;
            case GPUPixelFormat_R16Float:                 return DXGI_FORMAT_R16_FLOAT;
            case GPUPixelFormat_RG8Unorm:                 return DXGI_FORMAT_R8G8_UNORM;
            case GPUPixelFormat_RG8Snorm:                 return DXGI_FORMAT_R8G8_SNORM;
            case GPUPixelFormat_RG8Uint:                  return DXGI_FORMAT_R8G8_UINT;
            case GPUPixelFormat_RG8Sint:                  return DXGI_FORMAT_R8G8_SINT;
                // Packed 16-Bit Pixel Formats
            case GPUPixelFormat_B5G6R5Unorm:              return DXGI_FORMAT_B5G6R5_UNORM;
            case GPUPixelFormat_BGR5A1Unorm:              return DXGI_FORMAT_B5G5R5A1_UNORM;
            case GPUPixelFormat_BGRA4Unorm:               return DXGI_FORMAT_B4G4R4A4_UNORM;
                // 32-bit formats
            case GPUPixelFormat_R32Uint:                   return DXGI_FORMAT_R32_UINT;
            case GPUPixelFormat_R32Sint:                   return DXGI_FORMAT_R32_SINT;
            case GPUPixelFormat_R32Float:                  return DXGI_FORMAT_R32_FLOAT;
            case GPUPixelFormat_RG16Unorm:                 return DXGI_FORMAT_R16G16_UNORM;
            case GPUPixelFormat_RG16Snorm:                 return DXGI_FORMAT_R16G16_SNORM;
            case GPUPixelFormat_RG16Uint:                  return DXGI_FORMAT_R16G16_UINT;
            case GPUPixelFormat_RG16Sint:                  return DXGI_FORMAT_R16G16_SINT;
            case GPUPixelFormat_RG16Float:                 return DXGI_FORMAT_R16G16_FLOAT;
            case GPUPixelFormat_RGBA8Unorm:                return DXGI_FORMAT_R8G8B8A8_UNORM;
            case GPUPixelFormat_RGBA8UnormSrgb:            return DXGI_FORMAT_R8G8B8A8_UNORM_SRGB;
            case GPUPixelFormat_RGBA8Snorm:                return DXGI_FORMAT_R8G8B8A8_SNORM;
            case GPUPixelFormat_RGBA8Uint:                 return DXGI_FORMAT_R8G8B8A8_UINT;
            case GPUPixelFormat_RGBA8Sint:                 return DXGI_FORMAT_R8G8B8A8_SINT;
            case GPUPixelFormat_BGRA8Unorm:                return DXGI_FORMAT_B8G8R8A8_UNORM;
            case GPUPixelFormat_BGRA8UnormSrgb:            return DXGI_FORMAT_B8G8R8A8_UNORM_SRGB;
                // Packed 32-Bit formats
            case GPUPixelFormat_RGB10A2Unorm:              return DXGI_FORMAT_R10G10B10A2_UNORM;
            case GPUPixelFormat_RGB10A2Uint:               return DXGI_FORMAT_R10G10B10A2_UINT;
            case GPUPixelFormat_RG11B10Ufloat:             return DXGI_FORMAT_R11G11B10_FLOAT;
            case GPUPixelFormat_RGB9E5Ufloat:              return DXGI_FORMAT_R9G9B9E5_SHAREDEXP;
                // 64-Bit formats
            case GPUPixelFormat_RG32Uint:                 return DXGI_FORMAT_R32G32_UINT;
            case GPUPixelFormat_RG32Sint:                 return DXGI_FORMAT_R32G32_SINT;
            case GPUPixelFormat_RG32Float:                return DXGI_FORMAT_R32G32_FLOAT;
            case GPUPixelFormat_RGBA16Unorm:              return DXGI_FORMAT_R16G16B16A16_UNORM;
            case GPUPixelFormat_RGBA16Snorm:              return DXGI_FORMAT_R16G16B16A16_SNORM;
            case GPUPixelFormat_RGBA16Uint:               return DXGI_FORMAT_R16G16B16A16_UINT;
            case GPUPixelFormat_RGBA16Sint:               return DXGI_FORMAT_R16G16B16A16_SINT;
            case GPUPixelFormat_RGBA16Float:              return DXGI_FORMAT_R16G16B16A16_FLOAT;
                // 128-Bit formats
            case GPUPixelFormat_RGBA32Uint:               return DXGI_FORMAT_R32G32B32A32_UINT;
            case GPUPixelFormat_RGBA32Sint:               return DXGI_FORMAT_R32G32B32A32_SINT;
            case GPUPixelFormat_RGBA32Float:              return DXGI_FORMAT_R32G32B32A32_FLOAT;
                // Depth-stencil formats
            //case PixelFormat_Stencil8:                 return DXGI_FORMAT_D24_UNORM_S8_UINT;
            case GPUPixelFormat_Depth16Unorm:              return DXGI_FORMAT_D16_UNORM;
            case GPUPixelFormat_Depth24UnormStencil8:      return DXGI_FORMAT_D24_UNORM_S8_UINT; // UsePackedDepth24UnormStencil8Format ? DXGI_FORMAT_D24_UNORM_S8_UINT : DXGI_FORMAT_D32_FLOAT_S8X24_UINT;
            case GPUPixelFormat_Depth32Float:              return DXGI_FORMAT_D32_FLOAT;
            case GPUPixelFormat_Depth32FloatStencil8:      return DXGI_FORMAT_D32_FLOAT_S8X24_UINT;
                // Compressed BC formats
            case GPUPixelFormat_BC1RGBAUnorm:             return DXGI_FORMAT_BC1_UNORM;
            case GPUPixelFormat_BC1RGBAUnormSrgb:         return DXGI_FORMAT_BC1_UNORM_SRGB;
            case GPUPixelFormat_BC2RGBAUnorm:             return DXGI_FORMAT_BC2_UNORM;
            case GPUPixelFormat_BC2RGBAUnormSrgb:         return DXGI_FORMAT_BC2_UNORM_SRGB;
            case GPUPixelFormat_BC3RGBAUnorm:             return DXGI_FORMAT_BC3_UNORM;
            case GPUPixelFormat_BC3RGBAUnormSrgb:         return DXGI_FORMAT_BC3_UNORM_SRGB;
            case GPUPixelFormat_BC4RSnorm:                return DXGI_FORMAT_BC4_UNORM;
            case GPUPixelFormat_BC4RUnorm:                return DXGI_FORMAT_BC4_SNORM;
            case GPUPixelFormat_BC5RGUnorm:               return DXGI_FORMAT_BC5_UNORM;
            case GPUPixelFormat_BC5RGSnorm:               return DXGI_FORMAT_BC5_SNORM;
            case GPUPixelFormat_BC6HRGBUfloat:            return DXGI_FORMAT_BC6H_UF16;
            case GPUPixelFormat_BC6HRGBFloat:             return DXGI_FORMAT_BC6H_SF16;
            case GPUPixelFormat_BC7RGBAUnorm:             return DXGI_FORMAT_BC7_UNORM;
            case GPUPixelFormat_BC7RGBAUnormSrgb:         return DXGI_FORMAT_BC7_UNORM_SRGB;
    ...
    inline DXGI_FORMAT ToDxgiRTVFormat(GPUPixelFormat format)
    {
        return ToDxgiFormat(format);
    }

    inline DXGI_FORMAT ToDxgiDSVFormat(GPUPixelFormat format)
    {
        return ToDxgiFormat(format);
    }

    [[maybe_unused]] inline DXGI_FORMAT ToDxgiSRVFormat(GPUPixelFormat format)
    {
    ...
    [[maybe_unused]] inline DXGI_FORMAT ToDxgiUAVFormat(GPUPixelFormat format)
    {
        return ToDxgiFormat(format);
    }
    ...
    [[nodiscard]] constexpr D3D12_QUERY_HEAP_TYPE ToD3D12(GPUQueryType value)
    {
        switch (value)
        {
            case GPUQueryType_Timestamp:
            case GPUQueryType_TimestampCopyQueue:
                return D3D12_QUERY_HEAP_TYPE_TIMESTAMP;
                //return D3D12_QUERY_HEAP_TYPE_COPY_QUEUE_TIMESTAMP;

            case GPUQueryType_Occlusion:
            case GPUQueryType_BinaryOcclusion:
                return D3D12_QUERY_HEAP_TYPE_OCCLUSION;

            case GPUQueryType_PipelineStatistics:
    ...
    constexpr DXGI_FORMAT GetTypelessFormatFromDepthFormat(GPUPixelFormat format)
    {
    ...
    [[nodiscard]] constexpr DXGI_FORMAT ToDxgiSwapChainFormat(GPUPixelFormat format)
    {
        // FLIP_DISCARD and FLIP_SEQEUNTIAL swapchain buffers only support these formats
        switch (format)
        {
            case GPUPixelFormat_RGBA16Float:
                return DXGI_FORMAT_R16G16B16A16_FLOAT;

            case GPUPixelFormat_BGRA8Unorm:
            case GPUPixelFormat_BGRA8UnormSrgb:
                return DXGI_FORMAT_B8G8R8A8_UNORM;

            case GPUPixelFormat_RGBA8Unorm:
            case GPUPixelFormat_RGBA8UnormSrgb:
                return DXGI_FORMAT_R8G8B8A8_UNORM;

            case GPUPixelFormat_RGB10A2Unorm:
    ...
    [[nodiscard]] constexpr GPUShaderModel FromD3D12(D3D_SHADER_MODEL value)
    {
        switch (value)
        {
    ...
    [[nodiscard]] constexpr GPURayTracingTier FromD3D12(D3D12_RAYTRACING_TIER value)
    {
        switch (value)
        {
            case D3D12_RAYTRACING_TIER_NOT_SUPPORTED:
                return GPURayTracingTier_NotSupported;

            case D3D12_RAYTRACING_TIER_1_0:
                return GPURayTracingTier_1;

            case D3D12_RAYTRACING_TIER_1_1:
                return GPURayTracingTier_2;
    ...
    [[nodiscard]] constexpr GPUMeshShaderTier FromD3D12(D3D12_MESH_SHADER_TIER value)
    {
        switch (value)
        {
            case D3D12_MESH_SHADER_TIER_NOT_SUPPORTED:
                return GPUMeshShaderTier_NotSupported;

            case D3D12_MESH_SHADER_TIER_1:
                return GPUMeshShaderTier_1;
...
public:
    ...
    DescriptorIndex AllocateDescriptors(uint32_t count = 1u)
    {
        ...
        if (!found)
        {
            ...
            {
                agpuLogError("D3D12: Failed to grow a descriptor heap!");
    ...
    void ReleaseDescriptors(DescriptorIndex baseIndex, uint32_t count)
    {
        ...
        for (DescriptorIndex index = baseIndex; index < baseIndex + count; index++)
        {
            ...
            if (!allocatedDescriptors[index])
            {
                agpuLogError("D3D12: Attempted to release an un-allocated descriptor");
            }
#endif
...
private:
    ...
    HRESULT Grow(uint32_t minRequiredSize)
    {
        ...
        uint32_t newSize = NextPow2(minRequiredSize);
...
struct D3D12SwapChain final : public GPUSwapChain
{
    D3D12Device* device = nullptr;
...
void D3D12Buffer::SetLabel(const char* label)
{
    ...
    if (!wideLabel.empty())
    {
        ...
        if (allocation)
        {
            allocation->SetName(wideLabel.c_str());
        }
    }
}
...
D3D12_CPU_DESCRIPTOR_HANDLE D3D12Texture::GetRTV(DXGI_FORMAT rtvFormat, uint32_t mipLevel) const
{
    ...
    switch (desc.dimension)
    {
        ...
        default:
            agpuLogError("Invalid TextureView type");
            return {};
    }
...
void D3D12RenderPassEncoder::SetBlendColor(const GPUColor* color)
{
...
void D3D12RenderPassEncoder::SetShadingRate(GPUShadingRate rate)
{
    ...
    if (adapter->features.VariableShadingRateTier() != D3D12_VARIABLE_SHADING_RATE_TIER_NOT_SUPPORTED
...
ID3D12CommandList* D3D12CommandBuffer::End()
{
    for (auto& swapChain : presentSwapChains)
    {
        TextureBarrier(swapChain->backbufferTextures[swapChain->backBufferIndex], TextureLayout::Present);
    }
    CommitBarriers();
...
#endif
    {
        std::wstring wideLabel = ToUtf16(groupLabel);
        if (!wideLabel.empty())
        {
            PIXBeginEvent(commandList, PIX_COLOR_DEFAULT, wideLabel.c_str());
        }
    }
}
...
#endif
    {
        std::wstring wideLabel = ToUtf16(markerLabel);
        if (!wideLabel.empty())
        {
            PIXSetMarker(commandList, PIX_COLOR_DEFAULT, wideLabel.c_str());
        }
    }
}
...
D3D12UploadContext D3D12CopyAllocator::Allocate(uint64_t size)
{
    ...
    if (!context.IsValid())
    {
        ...
        bufferDesc.Width = NextPow2(size);
        bufferDesc.Height = 1;
...
D3D12Device::~D3D12Device()
{
    ...
    if (allocator != nullptr)
    {
        ...
        {
            agpuLogWarn("Total device memory leaked: %" PRId64 " bytes.", stats.Total.Stats.AllocationBytes);
        }
    ...
    if (refCount)
    {
        agpuLogError("There are %d unreleased references left on the D3D device!", refCount);
...
GPUTexture* D3D12Device::CreateTexture(const GPUTextureDesc& desc, const GPUTextureData* pInitialData)
{
    ...
    {
        delete texture;
        agpuLogError("D3D12: Failed to create texture");
        return nullptr;
    }
...
GPURenderPipeline D3D12Device::CreateRenderPipeline(const GPURenderPipelineDesc& desc)
{
    ...
    for (uint32_t i = 0; i < desc.colorAttachmentCount; ++i)
    {
        ...
        // RTV
        RTVFormats.RTFormats[RTVFormats.NumRenderTargets] = ToDxgiFormat(attachment.format);
...
GPUQueryHeap* D3D12Device::CreateQueryHeap(const GPUQueryHeapDesc& desc)
{
    ...
    ID3D12QueryHeap* d3dHandle = nullptr;
    HRESULT hr = handle->CreateQueryHeap(&d3dDesc, IID_PPV_ARGS(&d3dHandle));
    if (FAILED(hr))
    {
        return nullptr;
    }
...
GPUSwapChain* D3D12Device::CreateSwapChain(GPUSurface* surface, const GPUSwapChainDesc& desc)
{
    D3D12SwapChain* swapChain = new D3D12SwapChain();
    swapChain->device = this;
    swapChain->desc = desc;
    swapChain->surface = static_cast<D3D12Surface*>(surface);
...
void D3D12Surface::GetCapabilities(GPUAdapter* adapter, GPUSurfaceCapabilities* capabilities) const
{
    ...
    static const GPUPixelFormat kSupportedFormats[] = {
...
void D3D12SwapChain::Present()
{
    ...
    switch (desc.presentMode)
    {
        ...
        case GPUPresentMode_Immediate:
            syncInterval = 0;
            presentFlags = device->adapter->factory->tearingSupported ? DXGI_PRESENT_ALLOW_TEARING : 0;
            break;
    ...
    const HRESULT hr = handle->Present(syncInterval, presentFlags);
...
bool D3D12Adapter::Init(ID3D12Device* device)
{
    ...
    VHR(handle->GetDesc1(&adapterDesc));

    deviceName = ToUtf8(adapterDesc.Description);
    // Convert the adapter's D3D12 driver version to a readable string like "24.21.13.9793".
    LARGE_INTEGER umdVersion;
    if (handle->CheckInterfaceSupport(__uuidof(IDXGIDevice), &umdVersion) != DXGI_ERROR_UNSUPPORTED)
    {
        ...
        {
            driverVersion[i] = (encodedVersion >> (48 - 16 * i)) & mask;
            o << driverVersion[i] << ".";
        }
    ...
    copyQueueTimestampQueriesSupported = features.CopyQueueTimestampQueriesSupported() == TRUE;
    cacheCoherentUMA = features.CacheCoherentUMA() == TRUE;
    shaderOutputViewportIndex = features.VPAndRTArrayIndexFromAnyShaderFeedingRasterizerSupportedWithoutGSEmulation() == TRUE;

    return true;
}

void D3D12Adapter::GetInfo(GPUAdapterInfo* info) const
{
...
GPUDevice D3D12Adapter::CreateDevice(const GPUDeviceDesc& desc)
{
    ...
    {
        hr = d3d12_state.deviceFactory->CreateDevice(handle.Get(), D3D_FEATURE_LEVEL_12_0, IID_PPV_ARGS(&device->handle));
    }
    else
#endif
    {
        hr = d3d12_D3D12CreateDevice(handle.Get(), D3D_FEATURE_LEVEL_12_0, IID_PPV_ARGS(&device->handle));
    }
    ...
    if (factory->validationMode != GPUValidationMode_Disabled)
    {
        ...
        if (SUCCEEDED(device->handle->QueryInterface(infoQueue.GetAddressOf())))
        {
            ...
            if (factory->validationMode == GPUValidationMode_Verbose)
            {
    ...
    allocatorDesc.pAdapter = handle.Get();
...
GPUFactory* D3D12_CreateFactory(const GPUFactoryDesc* desc)
{
    ...
    if (factory->validationMode != GPUValidationMode_Disabled)
    {
        ...
        if (SUCCEEDED(hr))
        {
            ...
            if (factory->validationMode == GPUValidationMode_GPU)
            {
    ...
    VHR(dxgi_CreateDXGIFactory2(dxgiFactoryFlags, IID_PPV_ARGS(&factory->dxgiFactory4)));

    BOOL allowTearing = FALSE;
    ComPtr<IDXGIFactory5> dxgiFactory5;
    hr = factory->dxgiFactory4.As(&dxgiFactory5);
    if (SUCCEEDED(hr))
    {
    ...
    {
        factory->tearingSupported = false;
    }
    else
    {
        factory->tearingSupported = true;
    }
    ...
    const bool queryByPreference = SUCCEEDED(factory->dxgiFactory4.As(&dxgiFactory6));
    auto NextAdapter = [&](uint32_t index, IDXGIAdapter1** ppAdapter)
        {
            ...
            return factory->dxgiFactory4->EnumAdapters1(index, ppAdapter);
        };
