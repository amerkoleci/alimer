...
internal static unsafe partial class SDL3
{
    ...
    public struct SDL_Event
    {
        ...
        [FieldOffset(0)] public SDL_TextEditingCandidatesEvent edit_candidates;
    ...
    [LibraryImport(LibraryName)]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial int SDL_PeepEvents(SDL_Event* events, int numevents, SDL_EventAction action, uint minType, uint maxType);
    #endregion
