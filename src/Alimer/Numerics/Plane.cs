...
public partial struct Plane : IEquatable<Plane>, IFormattable, ISpanFormattable
{
    /// <summary>
    ...
    public Plane(in Vector3 point1, in Vector3 point2, in Vector3 point3)
    {
        ...
        Normal = new(nx * invNorm, ny * invNorm, nz * invNorm);
    ...
    public readonly PlaneIntersectionType Intersects(in BoundingSphere sphere)
    {
        return sphere.Intersects(this);
    }

    public readonly PlaneIntersectionType Intersects(in BoundingBox box)
    {
    ...
    /// <summary>
    /// Performs an implicit conversion from <see cref="Alimer.Numerics.Plane"/> to <see cref="System.Numerics.Plane"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
    public static implicit operator System.Numerics.Plane(in Plane value)
    {
        return System.Numerics.Plane.Create(value.Normal, value.D);
    }

    /// <summary>
    /// Performs an implicit conversion from <see cref="System.Numerics.Plane"/> to <see cref="Alimer.Numerics.Plane"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
