...
/// </summary>
public record struct GraphicsBufferDescriptor
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the <see cref="GraphicsBufferUsage"/> of the buffer.
    /// </summary>
    public GraphicsBufferUsage Usage = GraphicsBufferUsage.ShaderReadWrite;
