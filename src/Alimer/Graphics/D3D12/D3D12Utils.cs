...
{
    public static DXGI_FORMAT ToDxgiFormat(this VertexAttributeFormat format)
    {
        return format switch
        {
            VertexAttributeFormat.UByte => DXGI_FORMAT_R8_UINT,
            VertexAttributeFormat.UByte2 => DXGI_FORMAT_R8G8_UINT,
            VertexAttributeFormat.UByte4 => DXGI_FORMAT_R8G8B8A8_UINT,
            VertexAttributeFormat.Byte => DXGI_FORMAT_R8_SINT,
            VertexAttributeFormat.Byte2 => DXGI_FORMAT_R8G8_SINT,
            VertexAttributeFormat.Byte4 => DXGI_FORMAT_R8G8B8A8_SINT,
            VertexAttributeFormat.UByteNormalized => DXGI_FORMAT_R8_UNORM,
            VertexAttributeFormat.UByte2Normalized => DXGI_FORMAT_R8G8_UNORM,
            VertexAttributeFormat.UByte4Normalized => DXGI_FORMAT_R8G8B8A8_UNORM,
            VertexAttributeFormat.ByteNormalized => DXGI_FORMAT_R8_SNORM,
            VertexAttributeFormat.Byte2Normalized => DXGI_FORMAT_R8G8_SNORM,
            VertexAttributeFormat.Byte4Normalized => DXGI_FORMAT_R8G8B8A8_SNORM,
            VertexAttributeFormat.UShort => DXGI_FORMAT_R16_UINT,
            VertexAttributeFormat.UShort2 => DXGI_FORMAT_R16G16_UINT,
            VertexAttributeFormat.UShort4 => DXGI_FORMAT_R16G16B16A16_UINT,
            VertexAttributeFormat.Short => DXGI_FORMAT_R16_SINT,
            VertexAttributeFormat.Short2 => DXGI_FORMAT_R16G16_SINT,
            VertexAttributeFormat.Short4 => DXGI_FORMAT_R16G16B16A16_SINT,
            VertexAttributeFormat.UShortNormalized => DXGI_FORMAT_R16_UNORM,
            VertexAttributeFormat.UShort2Normalized => DXGI_FORMAT_R16G16_UNORM,
            VertexAttributeFormat.UShort4Normalized => DXGI_FORMAT_R16G16B16A16_UNORM,
            VertexAttributeFormat.ShortNormalized => DXGI_FORMAT_R16_SNORM,
            VertexAttributeFormat.Short2Normalized => DXGI_FORMAT_R16G16_SNORM,
            VertexAttributeFormat.Short4Normalized => DXGI_FORMAT_R16G16B16A16_SNORM,
            VertexAttributeFormat.Half => DXGI_FORMAT_R16_FLOAT,
            VertexAttributeFormat.Half2 => DXGI_FORMAT_R16G16_FLOAT,
            VertexAttributeFormat.Half4 => DXGI_FORMAT_R16G16B16A16_FLOAT,
            VertexAttributeFormat.Float => DXGI_FORMAT_R32_FLOAT,
            VertexAttributeFormat.Float2 => DXGI_FORMAT_R32G32_FLOAT,
            VertexAttributeFormat.Float3 => DXGI_FORMAT_R32G32B32_FLOAT,
            VertexAttributeFormat.Float4 => DXGI_FORMAT_R32G32B32A32_FLOAT,
            VertexAttributeFormat.UInt => DXGI_FORMAT_R32_UINT,
            VertexAttributeFormat.UInt2 => DXGI_FORMAT_R32G32_UINT,
            VertexAttributeFormat.UInt3 => DXGI_FORMAT_R32G32B32_UINT,
            VertexAttributeFormat.UInt4 => DXGI_FORMAT_R32G32B32A32_UINT,
            VertexAttributeFormat.Int => DXGI_FORMAT_R32_SINT,
            VertexAttributeFormat.Int2 => DXGI_FORMAT_R32G32_SINT,
            VertexAttributeFormat.Int3 => DXGI_FORMAT_R32G32B32_SINT,
            VertexAttributeFormat.Int4 => DXGI_FORMAT_R32G32B32A32_SINT,
            VertexAttributeFormat.Unorm10_10_10_2 => DXGI_FORMAT_R10G10B10A2_UNORM,
            //VertexAttributeFormat.Snorm10_10_10_2 => DXGI_FORMAT_R10G10B10A2_UNORM,
            VertexAttributeFormat.Unorm8x4BGRA => DXGI_FORMAT_B8G8R8A8_UNORM,
