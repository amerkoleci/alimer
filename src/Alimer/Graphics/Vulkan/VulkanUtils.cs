...
internal static class VulkanUtils
{
    ...
    public static VkFormat ToVk(this VertexAttributeFormat format)
    {
        return format switch
        {
            VertexAttributeFormat.UByte => VK_FORMAT_R8_UINT,
            VertexAttributeFormat.UByte2 => VK_FORMAT_R8G8_UINT,
            VertexAttributeFormat.UByte4 => VK_FORMAT_R8G8B8A8_UINT,
            VertexAttributeFormat.Byte => VK_FORMAT_R8_SINT,
            VertexAttributeFormat.Byte2 => VK_FORMAT_R8G8_SINT,
            VertexAttributeFormat.Byte4 => VK_FORMAT_R8G8B8A8_SINT,
            VertexAttributeFormat.UByteNormalized => VK_FORMAT_R8_UNORM,
            VertexAttributeFormat.UByte2Normalized => VK_FORMAT_R8G8_UNORM,
            VertexAttributeFormat.UByte4Normalized => VK_FORMAT_R8G8B8A8_UNORM,
            VertexAttributeFormat.ByteNormalized => VK_FORMAT_R8_SNORM,
            VertexAttributeFormat.Byte2Normalized => VK_FORMAT_R8G8_SNORM,
            VertexAttributeFormat.Byte4Normalized => VK_FORMAT_R8G8B8A8_SNORM,
            VertexAttributeFormat.UShort => VK_FORMAT_R16_UINT,
            VertexAttributeFormat.UShort2 => VK_FORMAT_R16G16_UINT,
            VertexAttributeFormat.UShort4 => VK_FORMAT_R16G16B16A16_UINT,
            VertexAttributeFormat.Short => VK_FORMAT_R16_SINT,
            VertexAttributeFormat.Short2 => VK_FORMAT_R16G16_SINT,
            VertexAttributeFormat.Short4 => VK_FORMAT_R16G16B16A16_SINT,
            VertexAttributeFormat.UShortNormalized => VK_FORMAT_R16_UNORM,
            VertexAttributeFormat.UShort2Normalized => VK_FORMAT_R16G16_UNORM,
            VertexAttributeFormat.UShort4Normalized => VK_FORMAT_R16G16B16A16_UNORM,
            VertexAttributeFormat.ShortNormalized => VK_FORMAT_R16_SNORM,
            VertexAttributeFormat.Short2Normalized => VK_FORMAT_R16G16_SNORM,
            VertexAttributeFormat.Short4Normalized => VK_FORMAT_R16G16B16A16_SNORM,
            VertexAttributeFormat.Half => VK_FORMAT_R16_SFLOAT,
            VertexAttributeFormat.Half2 => VK_FORMAT_R16G16_SFLOAT,
            VertexAttributeFormat.Half4 => VK_FORMAT_R16G16B16A16_SFLOAT,
            VertexAttributeFormat.Float => VK_FORMAT_R32_SFLOAT,
            VertexAttributeFormat.Float2 => VK_FORMAT_R32G32_SFLOAT,
            VertexAttributeFormat.Float3 => VK_FORMAT_R32G32B32_SFLOAT,
            VertexAttributeFormat.Float4 => VK_FORMAT_R32G32B32A32_SFLOAT,
            VertexAttributeFormat.UInt => VK_FORMAT_R32_UINT,
            VertexAttributeFormat.UInt2 => VK_FORMAT_R32G32_UINT,
            VertexAttributeFormat.UInt3 => VK_FORMAT_R32G32B32_UINT,
            VertexAttributeFormat.UInt4 => VK_FORMAT_R32G32B32A32_UINT,
            VertexAttributeFormat.Int => VK_FORMAT_R32_SINT,
            VertexAttributeFormat.Int2 => VK_FORMAT_R32G32_SINT,
            VertexAttributeFormat.Int3 => VK_FORMAT_R32G32B32_SINT,
            VertexAttributeFormat.Int4 => VK_FORMAT_R32G32B32A32_SINT,
