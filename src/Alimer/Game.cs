...
public abstract class Game : DisposableObject, IGame
{
    ...
    protected Game(GamePlatform? platform = default, string? name = default)
    {
        Platform = platform ?? GamePlatform.CreateDefault();
        ...
        //deviceDescription.PreferredBackend = GraphicsBackendType.D3D11;
#endif

        GraphicsDevice = new GraphicsDevice(in deviceDescription);
    ...
    /// </summary>
    public GameView MainView => Platform.MainView;
